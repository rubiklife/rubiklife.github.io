...
> 注：如下的搭建和安装脚本可参看本库的 scripts 目录下的脚本，如： [Ubuntu 18.04 Installation Script](https://github.com/rubiklife/rubiklife.github.io/blob/master/scripts/install.ubuntu.18.04.sh) 
...
- **内存泄漏问题**。 目前，`warp-svc` 这个程序有内存泄漏的问题，需要你定期重启服务。可以使用cronjob来重启服务。运行 `crontab -e`，然后添加如下内容：
...
科学上网是获取全球信息、拓宽视野的重要手段。通过自建服务，你可以获得更安全、更稳定的科学上网体验。尽管自建需要一定的技术能力和成本投入，但随着经验的积累，你将能够掌握更多网络知识，并获得更好的上网体验。

请记住，科学上网的目的是为了学习和工作，善用这一工具，让我们的视野不再局限。 （本文大部分均来自于：[左耳朵耗子的科学上网](https://github.com/haoel/haoel.github.io) ，结合自己自建过程中摸索实践并记录更新的文档）